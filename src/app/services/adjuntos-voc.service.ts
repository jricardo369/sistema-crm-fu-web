...
export class AdjuntosVocService {
    ...
    insertarAdjunto(idSolicitud: number, archivo: File, idUsuario: number) {
        ...
        return new Promise((resolve, reject) => this.http
            .post(API_URL + 'adjuntos-voc/' + idSolicitud + '/adjunto', formData,
                {
                    params: params,
                    withCredentials: true,
                    observe: 'response',
    ...
    eliminarAdjunto(idImagen: number, idUsuario: number) {
        ...
        return new Promise((resolve, reject) => this.http
            .delete(API_URL + 'adjuntos-voc/' + idImagen,
                {
                    params: params,
                    withCredentials: true,
                    observe: 'response',
